...
RSpec.describe MapquestService do
  it 'gets the optimized route for given locations' do
    stub_request(:get, "http://www.mapquestapi.com/directions/v2/optimizedroute?json=%7B'locations':%5B%228242%20George%20Early%20Rd,%20Centerville,%20IN%2047330%22,%20%22706%20Poplar%20Avenue,%20Centerville,%20IN%2047330%22,%20%22203%20McMinn%20Rd,%20Centerville,%20IN%2047330%22,%20%229021%20College%20Corner%20Rd,%20Greens%20Fork%20IN,%2047345%22%5D%7D&key=#{ENV['mapquest_key']}").to_return(body: File.read(File.join('spec', 'fixtures', 'mapquest_service.json')))
